...
**G1：方法可行性开发中，尚未通过。** 前景身份方法已接入4份新DA3估计相机快照及18个可撤回补丁，但两个正常接受结果偏轴19–24cm。相机替换诊断支持优先处理位姿误差。第三版共同读取器修复已知假断裂/双杆反例，仍有半边表面、噪声和宽度限制；独立对象与估计相机下重复收益尚未成立。继续冲刺9月27日验收，不能预先承诺通过。

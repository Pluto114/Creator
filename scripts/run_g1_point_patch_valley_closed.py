...
from creator_eval.common_readout_valley_closed import readout  # noqa: E402
...
CONFIG = ROOT / "configs/g1_point_patch_valley_closed_v1.json"
RUN_ID = "g1-point-patch-valley-closed-v1-20260924"
SOURCES = ["scripts/run_g1_point_patch_valley_closed.py", "experiments/src/creator_eval/common_readout_components.py", "reconstruction/src/creator_recon/domain/point_patch.py", "experiments/src/creator_eval/common_readout.py",
           ...
           "experiments/src/creator_eval/common_readout_sections.py", "experiments/src/creator_eval/common_readout_valley_closed.py"]
...
def prepare(path):
    ...
    for name in ("scripts/run_g1_point_patch_valley_closed.py", "experiments/src/creator_eval/common_readout_valley_closed.py", "configs/g1_point_patch_valley_closed_v1.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--share-json", type=Path, default=ROOT / "docs/experiments/results/2026-09-24-point-patch-valley-closed.json")

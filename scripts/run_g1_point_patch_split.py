"""Apply the frozen transverse-split reader to all seven complete historical pairs."""
...
from creator_eval.common_readout_split import readout  # noqa: E402

RUN_ID = "g1-point-patch-split-v1-20260922"
CONFIG = ROOT / "configs/g1_point_patch_split_v1.json"
SOURCES = [*pipeline.SOURCES, "scripts/run_g1_point_patch_split.py", "experiments/src/creator_eval/common_readout_split.py"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--share-json", type=Path, default=ROOT / "docs/experiments/results/2026-09-22-point-patch-split.json")

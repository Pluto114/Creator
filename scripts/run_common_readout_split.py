"""Freeze separated analytic inputs/GT, run both readers, then score all conditions."""
...
CONFIG = ROOT / "configs/common_readout_split_v1.json"
SOURCES = ["scripts/run_common_readout_split.py", "scripts/check_common_readout_ceiling.py",
...
READERS = dict(straight_components=component_readout, transverse_split=split_readout)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run-id", default="common-readout-split-controls-v1-20260922")
    parser.add_argument("--output", type=Path, default=ROOT / "docs/experiments/results/2026-09-22-readout-split-controls.json")

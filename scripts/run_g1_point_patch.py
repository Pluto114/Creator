...
CONFIG = ROOT / "configs/g1_point_patch_v1r2.json"
RUN_ID = "g1-point-patch-v1-20260922r2"
SOURCES = ["reconstruction/src/creator_recon/domain/point_patch.py", "experiments/src/creator_eval/common_readout.py",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--share-json", type=Path, default=ROOT / "docs/experiments/results/2026-09-22-point-patch-r2.json")

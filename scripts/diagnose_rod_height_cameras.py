...
DIAGNOSTIC = 'rod-height-camera-counterfactual-v1-20260923'
...
def run():
    ...
    sources = source_snapshot(diagnostic, [*frozen['source_sha256'], 'scripts/diagnose_rod_height_cameras.py'])
    ...
    write_json(ROOT / 'docs/experiments/results/2026-09-23-rod-height-camera-counterfactual.json', result)

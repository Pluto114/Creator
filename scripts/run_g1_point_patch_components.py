"""Freeze, materialize, compose/withdraw and jointly read historical model outputs."""
...
from creator_eval.common_readout_components import readout  # noqa: E402
...
CONFIG = ROOT / "configs/g1_point_patch_components_v1.json"
RUN_ID = "g1-point-patch-components-v1-20260922"
SOURCES = ["scripts/run_g1_point_patch_components.py", "experiments/src/creator_eval/common_readout_components.py", "reconstruction/src/creator_recon/domain/point_patch.py", "experiments/src/creator_eval/common_readout.py",
...
def prepare(path):
    ...
    write_json(run / "prepared.json", dict(run_id=config["run_id"], state="prepared", source_sha256=hashes,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--share-json", type=Path, default=ROOT / "docs/experiments/results/2026-09-22-point-patch-components.json")

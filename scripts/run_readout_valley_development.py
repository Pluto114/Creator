...
from creator_eval.common_readout_valley import DEFAULTS as VALLEY_DEFAULTS  # noqa: E402
from creator_eval.common_readout_valley import readout as valley_readout  # noqa: E402
from creator_eval.line_controls import curve_metrics, gap_coverage  # noqa: E402

CONFIG = ROOT / "configs/readout_valley_development_v1.json"
RUN_ID = "readout-valley-development-v1-20260924"
READERS = {"robust_sections": section_readout, "persistent_valley": valley_readout}
POLICIES = {"robust_sections": SECTION_DEFAULTS, "persistent_valley": VALLEY_DEFAULTS}
SOURCES = ["scripts/run_readout_valley_development.py", "experiments/src/creator_eval/readout_background_controls.py",
           "tests/test_common_readout_valley.py", "experiments/src/creator_eval/common_readout.py",
           ...
           "experiments/src/creator_eval/common_readout_valley.py"]
NEW_FILES = [SOURCES[0], SOURCES[2], SOURCES[-1], "configs/readout_valley_development_v1.json"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "docs/experiments/results/2026-09-24-readout-valley-development.json")
